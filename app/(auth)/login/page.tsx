      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-700 shadow-sm transition hover:bg-zinc-50"
            >
